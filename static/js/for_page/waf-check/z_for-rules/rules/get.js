const url___tok = "http://127.0.0.1:81/json-get-setting";
const url_edit = "http://127.0.0.1:81/json-get-setting-edit";
const url_check = "http://127.0.0.1:81/json-get-setting-check";
...
function to_table(id, use_num) {
    ...
    layui.use(['table'], function () {
        ...
        table.render({
            ...
            cols: [[
                {
                    field: 're-rules', width: '70%', title: '正则条件', templet: function (d) {
                        return '<input id="' + d.id + '" name="" value="' + d['re-rules'] + '" style="width:100%;border:0;height:95%;" readonly="readonly">';
                    }
                },
                { field: 'expl', width: '20%', title: '规则说明' },
                {
                    field: 'check', width: '10%', title: '规则开关', align: 'center', templet: function (d) {
