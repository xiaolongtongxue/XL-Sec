        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://www.txk123.top" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i>作者的个人小站</a>\n' +
                    '<a class="more-menu-item" onclick="javascript:dark_mode()"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i>白天/黑夜模式（谨慎使用）</a>\n' +
                    ...
                    '</div>';
                layer.open({
                    type: 1, title: false, closeBtn: 0, shade: 0.2, anim: 2, shadeClose: true, id: 'layuiminiBgColor', area: ['340px', clientHeight + 'px'], offset: 'rb', content: html, success: function (index, layero) { }, end: function () { $('.layuimini-select-bgcolor').removeClass('layui-this'); }
                });
                layer.close(loading);
            });
